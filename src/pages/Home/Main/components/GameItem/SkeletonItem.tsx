...
const SkeletonItem: React.FC = () => {
    return (
        <div className={styles.skeleton_block}>
            <Skeleton className={styles.imageSkeleton} containerClassName={styles.skeleton_padding}/>
            ...
            <div className={styles.flex}>
                ...
                <Skeleton height={8} width={20} className={styles.last_item} containerClassName={styles.align_right}/>
            </div>
